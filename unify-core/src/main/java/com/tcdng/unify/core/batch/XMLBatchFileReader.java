...
@Parameters({
		@Parameter(name = XMLBatchFileReaderInputConstants.BATCH_TAG_NAME, description = "$m{batchfilereader.xml.batchtagname}", editor = "!ui-name minLen:1 size:24", mandatory = true),
		@Parameter(name = XMLBatchFileReaderInputConstants.BATCHITEM_TAG_NAME, description = "$m{batchfilereader.xml.batchitemtagname}", editor = "!ui-name minLen:1 size:24", mandatory = true) })
