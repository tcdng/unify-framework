...
public class UnifyContainer {
    ...
    public UnifyContainer() {
        ...
        cachedLocaleUplComponentMap = new LocaleFactoryMaps<String, UplComponent>()
            {
                @Override
                protected UplComponent createObject(Locale locale, String descriptor, Object... params)
                        throws Exception {
     ...
     * @throws UnifyException
     *                        if container is not started. If component with name is
     ...
     *                        the annotation
     * @param packages
     *                        packages to restrict search to. This parameter is
     *                        optional.
     ...
     *                         packages to exclude search from. This parameter is
     *                         optional.
     * @return list of annotated classes
     * @throws UnifyException
     *                        if an error occurs
                ...
                if (configValues != null) {
                    ...
                    switch (type) {
                        case COMPONENT_ARRAY:
                            Object[] tempArray = createOrRetrieveComponents(fieldUnifyComponentType, configValues)
                                    .values().toArray();
    ...
    private void buildPropertyInjectionInfo(InternalUnifyComponentInfo iuci) throws UnifyException {
        ...
        for (String property : settings.getPropertyNames()) {
            ...
            injectInfoList.add(new InternalInjectInfo(type, setterInfo, configValues, unifyComponentType));
        }
    ...
    private static class InternalInjectInfo {
        ...
        public InternalInjectInfo(InjectType type, GetterSetterInfo setterInfo, String[] configValues,
