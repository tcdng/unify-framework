...
public enum FilterConditionType implements EnumConst {
    ...
    NOT_EQUALS(
            "NEQ",
            RestrictionType.NOT_EQUALS,
            "condition.notequals.label",
    ...
    LESS_OR_EQUAL(
            "LTE",
            RestrictionType.LESS_OR_EQUAL,
            "condition.lessorequal.label",
    ...
    GREATER_THAN(
            "GT",
            RestrictionType.GREATER,
            "condition.greaterthan.label",
    ...
    GREATER_OR_EQUAL(
            "GTE",
            RestrictionType.GREATER_OR_EQUAL,
            "condition.greaterorequal.label",
    ...
    NOT_BETWEEN(
            "NBT",
            RestrictionType.NOT_BETWEEN,
            "condition.notbetween.label",
            "condition.notbetween.symbol",
            false,
            false) {
        @Override
        public void addSimpleCriteria(CriteriaBuilder cb, String fieldName, Object paramA, Object paramB) {
    ...
    NOT_AMONGST(
            "NIN",
            RestrictionType.NOT_AMONGST,
            "condition.notamongst.label",
            "condition.notamongst.symbol",
            false,
            false) {
        @Override
        public void addSimpleCriteria(CriteriaBuilder cb, String fieldName, Object paramA, Object paramB) {
    ...
    BEGINS_WITH(
            "BW",
            RestrictionType.BEGINS_WITH,
            "condition.beginswith.label",
            "condition.beginswith.symbol",
            false,
            false) {
        @Override
        public void addSimpleCriteria(CriteriaBuilder cb, String fieldName, Object paramA, Object paramB) {
    ...
    NOT_BEGIN_WITH(
            "NBW",
            RestrictionType.NOT_BEGIN_WITH,
            "condition.notbeginswith.label",
            "condition.notbeginswith.symbol",
            false,
            false) {
        @Override
        public void addSimpleCriteria(CriteriaBuilder cb, String fieldName, Object paramA, Object paramB) {
    ...
    NOT_END_WITH(
            "NEW",
            RestrictionType.NOT_END_WITH,
            "condition.notendswith.label",
            "condition.notendswith.symbol",
            false,
            false) {
        @Override
        public void addSimpleCriteria(CriteriaBuilder cb, String fieldName, Object paramA, Object paramB) {
    ...
    IS_NOT_NULL(
            "NNL",
            RestrictionType.IS_NOT_NULL,
            "condition.isnotnull.label",
            "condition.isnotnull.symbol",
            false,
            false) {
        @Override
        public void addSimpleCriteria(CriteriaBuilder cb, String fieldName, Object paramA, Object paramB) {
    ...
    NOT_EQUALS_FIELD(
            "NEQF",
            RestrictionType.NOT_EQUALS,
            "condition.notequalsfield.label",
    ...
    LESS_OR_EQUAL_FIELD(
            "LTEF",
            RestrictionType.LESS_OR_EQUAL,
            "condition.lessorequalfield.label",
    ...
    GREATER_THAN_FIELD(
            "GTF",
            RestrictionType.GREATER,
            "condition.greaterthanfield.label",
    ...
    GREATER_OR_EQUAL_FIELD(
            "GTEF",
            RestrictionType.GREATER_OR_EQUAL,
            "condition.greaterorequalfield.label",
    ...
    BETWEEN_FIELD(
            ...
            "condition.betweenfield.label",
            "condition.betweenfield.symbol",
            true,
            false) {
        @Override
        public void addSimpleCriteria(CriteriaBuilder cb, String fieldName, Object paramA, Object paramB) {
    ...
    NOT_BETWEEN_FIELD(
            "NBTF",
            RestrictionType.NOT_BETWEEN,
            "condition.notbetweenfield.label",
            "condition.notbetweenfield.symbol",
            true,
            false) {
        @Override
        public void addSimpleCriteria(CriteriaBuilder cb, String fieldName, Object paramA, Object paramB) {
    ...
    NOT_LIKE_FIELD(
            "NLKF",
            RestrictionType.NOT_LIKE,
            "condition.notlikefield.label",
            "condition.notlikefield.symbol",
            true,
            false) {
        @Override
        public void addSimpleCriteria(CriteriaBuilder cb, String fieldName, Object paramA, Object paramB) {
    ...
    BEGINS_WITH_FIELD(
            "BWF",
            RestrictionType.BEGINS_WITH,
            "condition.beginswithfield.label",
            "condition.beginswithfield.symbol",
            true,
            false) {
        @Override
        public void addSimpleCriteria(CriteriaBuilder cb, String fieldName, Object paramA, Object paramB) {
    ...
    NOT_BEGIN_WITH_FIELD(
            "NBWF",
            RestrictionType.NOT_BEGIN_WITH,
            "condition.notbeginswithfield.label",
            "condition.notbeginswithfield.symbol",
            true,
            false) {
        @Override
        public void addSimpleCriteria(CriteriaBuilder cb, String fieldName, Object paramA, Object paramB) {
    ...
    ENDS_WITH_FIELD(
            "EWF",
            RestrictionType.ENDS_WITH,
            "condition.endswithfield.label",
            "condition.endswithfield.symbol",
            true,
            false) {
        @Override
        public void addSimpleCriteria(CriteriaBuilder cb, String fieldName, Object paramA, Object paramB) {
    ...
    NOT_END_WITH_FIELD(
            "NEWF",
            RestrictionType.NOT_END_WITH,
            "condition.notendswithfield.label",
            "condition.notendswithfield.symbol",
            true,
            false) {
        @Override
        public void addSimpleCriteria(CriteriaBuilder cb, String fieldName, Object paramA, Object paramB) {
    ...
    EQUALS_COLLECTION(
            "EQC",
            RestrictionType.EQUALS,
            "condition.equalscollection.label",
            "condition.equalscollection.symbol",
            false,
            true) {
        @Override
        public void addSimpleCriteria(CriteriaBuilder cb, String fieldName, Object paramA, Object paramB) {
    ...
    NOT_EQUALS_COLLECTION(
            "NEQC",
            RestrictionType.NOT_EQUALS,
            "condition.notequalscollection.label",
            "condition.notequalscollection.symbol",
            false,
            true) {
        @Override
        public void addSimpleCriteria(CriteriaBuilder cb, String fieldName, Object paramA, Object paramB) {
    ...
    LESS_THAN_COLLECTION(
            "LTC",
            RestrictionType.LESS_THAN,
            "condition.lessthancollection.label",
            "condition.lessthancollection.symbol",
            false,
            true) {
        @Override
        public void addSimpleCriteria(CriteriaBuilder cb, String fieldName, Object paramA, Object paramB) {
    ...
    LESS_OR_EQUAL_COLLECTION(
            "LTEC",
            RestrictionType.LESS_OR_EQUAL,
            "condition.lessorequalcollection.label",
            "condition.lessorequalcollection.symbol",
            false,
            true) {
        @Override
        public void addSimpleCriteria(CriteriaBuilder cb, String fieldName, Object paramA, Object paramB) {
    ...
    GREATER_THAN_COLLECTION(
            "GTC",
            RestrictionType.GREATER,
            "condition.greaterthancollection.label",
            "condition.greaterthancollection.symbol",
            false,
            true) {
        @Override
        public void addSimpleCriteria(CriteriaBuilder cb, String fieldName, Object paramA, Object paramB) {
    ...
    GREATER_OR_EQUAL_COLLECTION(
            "GTEC",
            RestrictionType.GREATER_OR_EQUAL,
            "condition.greaterorequalcollection.label",
            "condition.greaterorequalcollection.symbol",
            false,
            true) {
        @Override
        public void addSimpleCriteria(CriteriaBuilder cb, String fieldName, Object paramA, Object paramB) {
