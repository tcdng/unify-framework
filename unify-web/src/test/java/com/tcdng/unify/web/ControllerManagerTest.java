...
public class ControllerManagerTest extends AbstractUnifyWebTest {
	...
	public void testGetPageControllerInfo() throws Exception {
		ControllerManager bbm = (ControllerManager) getComponent(
				WebApplicationComponents.APPLICATION_CONTROLLERMANAGER);
	...
	public void testPopulateControllerProperty() throws Exception {
		...
		bbm.getController(pathInfoRepository.getControllerPathParts("/testauthor"), true);
	...
	public void testExecutePageController() throws Exception {
		...
		Date birthDt = new Date();
		AuthorPageController apbb = (AuthorPageController) bbm.getController(pir.getControllerPathParts("/testauthor"),
				true);
