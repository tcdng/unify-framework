...
public class TextClockWriter extends AbstractControlWriter {
	...
	protected void doWriteStructureAndContent(ResponseWriter writer, Widget widget) throws UnifyException {
		...
		writer.write("<div");
		this.writeTagAttributes(writer, textClock);
		writer.write(">");
		writer.write("<span");
		this.writeTagStyleClass(writer, "tctitle");
		writer.write(">");
		writer.write(textClock.getDateTitle());
		writer.write("</span>");
		writer.writeHtmlFixedSpace();
		writer.write("<span");
		this.writeTagId(writer, textClock.getDateId());
		this.writeTagStyleClass(writer, "tccontent");
		writer.write(">");
		writer.write("</span>");
		writer.writeHtmlFixedSpace();
		writer.write("<span");
		...
		writer.writeHtmlFixedSpace();
		writer.write("<span");
		this.writeTagId(writer, textClock.getTimeId());
		this.writeTagStyleClass(writer, "tccontent");
		writer.write(">");
		writer.write("</span>");
		writer.write("</div>");
